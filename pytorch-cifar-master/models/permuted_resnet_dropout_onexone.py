...
class PermBasicBlock(nn.Module):
    ...
    def forward(self, x):
        out = F.relu(self.bn1(self.onexone1(self.dropout1(self.conv1(x)))))
        out = self.bn2(self.onexone2(self.dropout2(self.conv2(out))))
        out += self.shortcut(x)
        out = F.relu(out)
        return out
...
def PermResNet18_1x1_Dropout():
    return ResNet(BasicBlock, [2, 2, 2, 2])


def PermResNet34_1x1_Dropout():
    return ResNet(BasicBlock, [3, 4, 6, 3])


def PermResNet50_1x1_Dropout():
    return ResNet(Bottleneck, [3, 4, 6, 3])


def PermResNet101_1x1_Dropout():
    return ResNet(Bottleneck, [3, 4, 23, 3])


def PermResNet152_1x1_Dropout():
